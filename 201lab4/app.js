...
if(question === "yes"){
    ...
    if(answers.q3 === "yes"){
        ...
        response = alert("Incorrect. I actually enjoy playing games like Cat Mario and Getting Over It.");
    } else{
        response = alert("I asked you a question, please respond.");
    }
    ...
    document.write('<h3>',"Your Answers:",'</h3>',
        '<ul>','<li>',"English is my first language. You responded with: " + answers.q1,'</li>',
        '<li>',"I have a cat named Lili. You responded with: " + answers.q2,'</li>',
        '<li>',"Rage games are my favorite type of video games. You responded with: " + answers.q3,'</li>',
        '<li>',"I use Photoshop as my art program of choice. You responded with: " + answers.q4,'</li>',
        '<li>',"I have a hard time interacting with others because of face blindness. You responded with: " + answers.q5,'</li>','</ul>');
