...
do{
    ...
    if(input < numbers.n1){
        input = alert("I'm thinking of a number between 0 and 5...\n" + input + " is too low.");
    }
    if(input > numbers.n1){
        input = alert("I'm thinking of a number between 0 and 5...\n" + input + " is too high.");
    }
...
do{
    ...
    if(input < numbers.n2){
        input = alert("I'm thinking of a number between 0 and 10...\n" + input + " is too low.");
    }
    if(input > numbers.n2){
        input = alert("I'm thinking of a number between 0 and 10...\n" + input + " is too high.");
    }
...
do{
    ...
    if(input < (numbers.n3 - 10) ){
        input = alert("I'm thinking of a number between 0 and 50...\n" + input + " is way too low.");
    }
...
do{
    ...
    if(input < (numbers.n4 - 20) ){
        input = alert("I'm thinking of a number between 0 and 100...\n" + input + " is way too low.");
    }
...
do{
    ...
    if(input < (numbers.n5 - 50) ){
        input = alert("I'm thinking of a number between 0 and 500...\n" + input + " is way too low.");
    }
